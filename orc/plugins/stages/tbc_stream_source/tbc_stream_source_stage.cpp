...
// ---------------------------------------------------------------------------
// VideoFrameRepresentation backed by a TBCStreamReader. Owns the input file
...
class TBCStreamFrameRepresentation final : public VideoFrameRepresentation,
 ...
 public:
  TBCStreamFrameRepresentation(VideoSystem system, uint32_t frame_count,
                               ...
                               std::istream& input, int32_t black_16b_ire,
                               int32_t white_16b_ire, uint32_t buffer_frames,
